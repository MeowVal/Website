...
onMounted(() => {
  ...
  var vertices = [ MV.vec2(0.5, 0.5), MV.vec2(-0.5, 0.5), MV.vec2(-0.5, -0.5),
    MV.vec2(0.5, 0.5), MV.vec2(-0.5, -0.5), MV.vec2(0.5, -0.5) ];
  var colours = [ MV.vec4(1.0, 1.0, 1.0, 1.0), MV.vec4(1.0, 1.0, 1.0, 1.0), MV.vec4(1.0, 1.0, 1.0, 1.0), MV.vec4(1.0, 1.0, 1.0, 1.0), MV.vec4(1.0, 1.0, 1.0, 1.0), MV.vec4(1.0, 1.0, 1.0, 1.0) ];
