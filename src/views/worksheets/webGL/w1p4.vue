...
// Shader imports
import vert from '@/shaders/webGL/w1p4.vert?raw'
import frag from '@/shaders/webGL/w1p4.frag?raw'
...
onMounted(() => {
  ...
  const vertices = [MV.vec2(0.5, 0.5), MV.vec2(-0.5, 0.5), MV.vec2(-0.5, -0.5),
    MV.vec2(0.5, 0.5), MV.vec2(-0.5, -0.5), MV.vec2(0.5, -0.5)];
  const colours = [MV.vec4(1.0, 1.0, 1.0, 1.0), MV.vec4(1.0, 1.0, 1.0, 1.0), MV.vec4(1.0, 1.0, 1.0, 1.0), MV.vec4(1.0, 1.0, 1.0, 1.0), MV.vec4(1.0, 1.0, 1.0, 1.0), MV.vec4(1.0, 1.0, 1.0, 1.0)];
